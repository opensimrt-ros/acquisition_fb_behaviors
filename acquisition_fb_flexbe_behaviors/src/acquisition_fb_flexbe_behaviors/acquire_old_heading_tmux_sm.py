...
@author: frekle
'''
class acquire_old_heading_tmuxSM(Behavior):
	'''
	acquire with tmux and old heading
	'''


	def __init__(self):
		super(acquire_old_heading_tmuxSM, self).__init__()
		self.name = 'acquire_old_heading_tmux'
